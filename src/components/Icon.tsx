...
function Royalties({ width = 20, height = 20, className = '' }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
...
function Logout({ width = 20, height = 20, className = '' }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
...
function Delete({ width = 16, height = 16, className = '' }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
...
function Settings({ width = 16, height = 16, className = '' }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
