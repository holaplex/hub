...
export default function EditCredentialPage({ params: { credential } }: EditCredentialProps) {
  ...
  const [editCredential, editCredentialResult] = useMutation<
    EditCredentialData,
    EditCredentialVars
  >(EditCredential);
  ...
  const loading = projectsQuery.loading || credentialQuery.loading;
          ...
          <Card className="w-[492px] mt-7">
            ...
            {loading ? (
              <div className="flex flex-col gap-5 mt-5">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="w-44 h-5 rounded-md bg-gray-100 animate-pulse" />
                    <div className="w-44 h-5 rounded-md bg-gray-100 animate-pulse" />
                  </div>
                </div>
                <div>
              ...
              <Form className="flex flex-col mt-5" onSubmit={handleSubmit(onSubmit)}>
                <Form.Label name="Name" className="text-xs" asideComponent={<Icon.Help />}>
                  <Form.Input
                    {...register('name')}
                    autoFocus
                ...
                <div className="flex items-center justify-between">
                  <Link href="/credentials">
                    <Button
                      ...
                      variant="secondary"
                      disabled={editCredentialResult.loading}
                    >
                      Cancel
                    </Button>
                  </Link>
                  <Button
                    htmlType="submit"
                    className="self-end"
                    loading={editCredentialResult.loading}
                    disabled={editCredentialResult.loading}
                  >
                    Save changes
                  </Button>
