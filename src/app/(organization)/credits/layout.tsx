    ...
    <>
      <div className="h-full flex flex-col p-4">
        ...
        <div className="mt-8 flex gap-8">
          <div className="flex flex-col basis-1/3 gap-4 items-center p-6 bg-subtlebg">
          ...
          <div className="flex basis-2/3 gap-8 bg-subtlebg">
            <div className="flex gap-4 basis-1/3">
              <span className="font-bold">Credits used</span>
              <div></div>
            </div>
            <div className="flex gap-4 py-10 px-4 bg-highlightcell basis-2/3">
