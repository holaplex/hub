      ...
      >
        <Card className="w-[400px] p-8 text-left">
          ...
          <div className="flex gap-2">
            <div className="shrink px-4 py-3 bg-stone-900 border-stone-800 rounded-md truncate">
              {createWebhookResult.data?.createWebhook.secret}
            </div>
            <button
              onClick={copyText}
              className="flex-none aspect-square rounded-md w-12 flex items-center justify-center bg-stone-800 hover:bg-stone-959"
            >
