        ...
        <Table
          columns={[
            columnHelper.accessor('shortAddress', {
              header: () => (
                <div className="flex gap-2">
                  <span className="text-xs text-subtletext font-medium">Wallet</span>
                </div>
              ),
              cell: (info) => {
            ...
            columnHelper.accessor('owns', {
              ...
              header: () => (
                <div className="flex gap-2">
                  <span className="text-xs text-subtletext font-medium">Spent</span>
                </div>
              ),
              cell: (info) => {
                ...
                return (
                  <div className="flex gap-1 items-center">
                    ...
                    <span className="text-xs text-subtletext">SOL</span>
                  </div>
                );
              },
            }),
            columnHelper.accessor('owns', {
              ...
              header: () => (
                <div className="flex gap-2">
                  <span className="text-xs text-subtletext font-medium">Owned Editions</span>
                </div>
              ),
              cell: (info) => {
                const owns = info.getValue();
                ...
                return (
                  <div className="flex gap-1 items-center">
                    {owns} / <span className="text-xs text-subtletext">{share}%</span>
                  </div>
                );
              },
            }),
