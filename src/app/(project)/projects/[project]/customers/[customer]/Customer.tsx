      ...
      {loading ? (
        <div className="flex justify-between flex-row">
          <div className="flex flex-row gap-1  items-center">
            ...
            <div className="w-60 h-8 rounded-md bg-loadingui animate-pulse" />
          </div>
          <div className="flex flex-col gap-1 items-end">
            <div className="w-14 h-4 rounded-full bg-loadingui animate-pulse" />
            <div className="w-32 h-4 rounded-full bg-loadingui animate-pulse" />
          </div>
        </div>
      ) : (
        <div className="flex justify-between">
          ...
          <ul className="flex-row gap-4">
            <li className="flex flex-col items-end gap-1">
              <span className="text-subtletext font-medium text-xs">Registered</span>
