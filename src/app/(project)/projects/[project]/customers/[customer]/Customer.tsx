      ...
      {loading ? (
        <div className="flex justify-between flex-row text-gray-100">
          <div className="flex flex-row gap-1  items-center">
            ...
            <div className="w-60 h-8 rounded-md bg-stone-950 animate-pulse" />
          </div>
          <div className="flex flex-col gap-1 items-end">
            <div className="w-14 h-4 rounded-full bg-stone-950 animate-pulse" />
            <div className="w-32 h-4 rounded-full bg-stone-950 animate-pulse" />
          </div>
        </div>
      ) : (
