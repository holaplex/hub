...
There are some secrets required for the API. Reach out to a fellow engineer to to get the secrets files. They should be placed in the [helm](./helm) of the project and follow the pattern of secret.{service}.yaml.
